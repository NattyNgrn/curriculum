...
// num2 but not num1?
/* The difference between num1 and num2 is that num one is not inclusive,  
It can not use 1 or 10 but it can use 2-9. num2 is inclusive so it can use 1-10. */
...
//I found this exercise pretty easy the only thing I looked up was how to concatenate using `${}
